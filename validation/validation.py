...
def validate(config_path: str) -> Any:
    ...
    spec = {
        ...
        "Jobs, projects and routines' structure": {
            ...
            "Each job, project and routine must be a dictionary": check_third_level_dict,
        ...
        "Project fields": {
            ...
            "A project's path field must be strings": check_project_paths_strings,
            "A project's path field must be resolvable": check_project_paths_exist,
            "A project 'params' field can only be a dictionary": check_project_params_dict,
            "A project 'params' field's keys must be valid job names": check_project_params_keys,
            "A project 'params' field's value must be a dictionary": check_project_params_values,
        },
        "Job fields": {
            ...
            "A job's targets or skips field must be a list": check_jobs_targets_list,
            "A job's targets or skips field must contain project names or 'all'": check_jobs_targets_names,
        },
        "Routine fields": {
            "Routines must be a list": check_routines_list,
...
def check_not_blank(config: Any) -> Result:
    ...
    Args:
        config (Any): Configuration being validated
    
    Returns:
        Result: Validation's success and details
    """
    return Result(True)
